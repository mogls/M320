...
public class MarketSubContent extends UiInteractiveItem<JComponent> implements Renderable<JScrollPane> {
    ...
    public MarketSubContent(String titleName, StockMarket stockMarket) {
        this.name = titleName;
